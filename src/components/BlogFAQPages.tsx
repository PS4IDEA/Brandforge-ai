    ...
    return (
      <div className="space-y-12 animate-fade-in py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { title: isAr ? 'توليد الهوية والاستراتيجية المتكاملة' : 'Generate Brand and Strategy', desc: isAr ? 'أقوى أداة متكاملة لابتكار وتوليد الهوية التجارية والاستراتيجية التسويقية معاً في منصة عمل موحدة متطورة.' : 'The ultimate unified suite to create and align both brand identity characteristics and strategic marketing position in one dynamic workspace.', icon: <Zap className="w-6 h-6" />, targetPage: 'brand-creator-strategy' as Page },
            { title: isAr ? 'توليد الهوية التجارية الذكية' : 'Brand Identity Generator', desc: isAr ? 'ابتكر مفهوم الشعار، والشخصية لعلامتك التجارية، وأسلوبها اللغوي والتعبيري من فكرة أولية أو تسجيل صوتي.' : 'Craft custom logo concepts, brand personality traits, and linguistic style blueprints starting from a raw prompt or voice note.', icon: <Sparkles className="w-6 h-6" />, targetPage: 'brand-identity-generator' as Page },
            { title: isAr ? 'توليد استراتيجية العلامة التجارية' : 'Brand Strategy Generator', desc: isAr ? 'صمم استراتيجية متكاملة لعلامتك التجارية تحدد الجمهور المستهدف، والأهداف الاستراتيجية، وخطة التموضع في السوق بذكاء.' : 'Generate a complete brand strategy defining target audience, strategic goals, and market positioning blueprint with AI.', icon: <Award className="w-6 h-6" />, targetPage: 'brand-strategy-generator' as Page },
